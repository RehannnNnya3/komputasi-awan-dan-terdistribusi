...
|---|---|---|---|---|
| 21 | Gemini | Untuk pitfall Lack of Self-Healing, apakah penyelesaiannya harus selalu menggunakan teknologi kompleks seperti Kubernetes agar server bisa pulih otomatis saat crash? Mengingat FoodGo adalah aplikasi raksasa yang menghandle ribuan transaksi tetapi tim IT-nya masih berskala startup | Dalam era cloud modern, mengasumsikan bahwa server akan selalu sehat atau mengandalkan intervensi manusia (tim IT) untuk melakukan restart manual saat server crash adalah sebuah kegagalan fatal. Server di lingkungan cloud bisa tumbang kapan saja karena berbagai alasan tak terduga (OOM Killer/Out of Memory, deadlock kode, hingga kegagalan perangkat keras hypervisor cloud). Menyerahkan proses pemulihan pada respons manusia berarti membiarkan sistem mati tanpa kejelasan durasi (unpredictable downtime) selama manusia tersebut menyadari adanya masalah, masuk ke konsol server, dan mengetik perintah restart. | |
